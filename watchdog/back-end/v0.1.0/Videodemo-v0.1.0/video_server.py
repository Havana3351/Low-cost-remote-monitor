...
while(True):
    ...
    if background is None:
        ...
        #removepath = r'C:\Users\Y\Desktop\project\realtime\0%s.jpg' % (removepointer)
        removepath = r'/root/video/realtime/0%s.jpg' % (removepointer)
        if os.path.exists(removepath):
            os.remove(removepath)

        #指针文件的添加
        #pointerpath = r'C:\Users\Y\Desktop\project\realtime\0%s.jpg' % (realtimecounter)
        pointerpath = r'/root/video/realtime/0%s.jpg' % (realtimecounter)
        cv2.imwrite(pointerpath, image)

        #picpath = r'C:\Users\Y\Desktop\project\realtime\%s.jpg' % (realtimecounter)
        picpath = r'/root/video/realtime/%s.jpg' % (realtimecounter)
