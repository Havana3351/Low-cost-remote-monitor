    ...
    if (target):
        ...
        if (repeatavoidcounter > 50):
            ...
            if (picturecounter < 10):
                ...
                # 需被创建的保存路径
                #path = r'C:\Users\Y\Desktop\project\%s\%s\%s\%s' % (rpi_name, year, day, minute)
                ...
                # 图片路径
                #picpath = r'C:\Users\Y\Desktop\project\%s\%s\%s\%s\%s.jpg' % (rpi_name, year, day, minute, picturestr)
